    ...
    <>
            ...
            <div className="md:flex">
              ...
              <div className="p-8">
                ...
                <h2 className="block mt-1 text-3xl leading-tight font-bold text-black">
                  TEDxAshesiUniversity: Blurred Lines
                </h2>
                <p className="mt-2 text-gray-600">
                  Join us for an extraordinary day of inspiration and innovation
                  as we explore groundbreaking ideas that have the power to
                  reshape our world.
                </p>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600">
                ...
                people together to share a TED-like experience. At
                TEDxAshesiUniversity, where x = independently organized TED
                event, we believe in the power of ideas to change attitudes,
      ...
      <section className="py-20 bg-gray-50 px-4 md:px-8">
        <div className="container mx-auto max-w-6xl px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-4">Featured Past Events</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join us for thought-provoking talks, performances, and
              conversations that will inspire and challenge you.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Brief description of the upcoming event. This will give
                    visitors a quick overview of what to expect.
                  </p>
                  <Link
                    href={`/events/event-${i}`}
